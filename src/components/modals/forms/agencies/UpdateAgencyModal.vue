      ...
      <div class="modal-content card-palette modal-shell">
        ...
        <div class="modal-header card-palette-header modal-header-accent" id="kt_modal_update_agency_header">
          ...
          <div class="d-flex align-items-center">
            ...
            <div>
              <h2 class="fw-bold m-0 text-palette-primary fs-3">🏢 Aggiorna Agenzia</h2>
              <span class="text-palette-secondary fs-7 fw-semibold">Modifica i dati dell'agenzia selezionata</span>
            </div>
          </div>
          <!--end::Modal title-->
        ...
        <el-form @submit.prevent="submit()" :model="formData" :rules="rules" ref="formRef">
          ...
          <div class="modal-body py-10 px-lg-17">
            <!--begin::Scroll-->
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_agency_scroll" data-kt-scroll="true"
              ...
              <!--begin::Billing form-->
              <div id="kt_modal_add_agency_billing_info" class="collapse show">
                <!--begin::Input group-->
                  ...
                  <div class="col-12 col-md-6 col-lg-8 fv-row">
                    ...
                    <el-form-item prop="color">
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end w-100 p-3 shadow-lg" aria-labelledby="colorDropdownAgencyUpdate" style="max-height: 400px; overflow-y: auto;">
                          <div class="row g-2">
                            <div 
...
import { getCAPByCity, getAllCitiesByCAP, provinceCities } from "@/core/data/italian-geographic-data-loader";
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const selectColor = (color: string) => {
      ...
      const dropdownElement = document.getElementById('colorDropdownAgencyUpdate');
      if (dropdownElement) {
    ...
    watch(() => props.Id, async (first, second) => {
      if (first) {
        formData.value = await getAgency(props.Id)
