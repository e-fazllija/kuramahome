  ...
  <div class="modal fade" id="kt_modal_add_province" ref="addProvinceModalRef" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <div class="modal-content card-palette" style="border-radius: 0.95rem; box-shadow: 0 10px 30px var(--bs-shadow-color);">
        <div class="modal-header card-palette-header" id="kt_modal_add_province_header" style="background: linear-gradient(135deg, rgba(0, 119, 204, 0.1) 0%, rgba(0, 119, 204, 0.05) 100%); border-radius: 0.95rem 0.95rem 0 0;">
          <div class="d-flex align-items-center">
            ...
            <div>
              <h2 class="fw-bold m-0 text-palette-primary fs-3">Aggiungi Provincia</h2>
              <span class="text-palette-secondary fs-7 fw-semibold">Inserisci i dati della nuova provincia</span>
            </div>
          </div>
          <div
        ...
        <form @submit.prevent="handleSubmit" class="form">
          ...
          <div class="modal-footer flex-center card-palette-footer" style="border-radius: 0 0 0.95rem 0.95rem; padding: 1.5rem 2rem;">
            <button
              type="button"
